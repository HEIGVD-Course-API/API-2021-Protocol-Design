...
public class Server {
    ...
    protected int port = 1339;

    public void sendWelcomeMessage(BufferedWriter out) throws IOException {
    ...
    public Calculus parseClientMessage(BufferedReader in) throws IOException {
    ...
    public int processCalculus(Calculus calculus) {
    ...
    public void handleError(int returnCode, BufferedWriter out) throws IOException {
    ...
    private void start() {
            ...
            while (true) {
                System.out.println("MultiThreaded: Waiting for client to connect\n");
                new Thread(new ReceptionistWorker()).run();
            }
    }
}
